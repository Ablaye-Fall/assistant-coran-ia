...
# Extraction des textes de tafsir depuis la clé "es_tafsir"
textes_tafsir = []
tafsir_keys = []
...
st.title("📖 Assistant Coran avec IA (Tafsir As-Saadi - 🇪🇸 Espagnol)")
...
langue_trad = st.selectbox("🌐 Traduire le tafsir en :", ["es", "fr", "en", "ar", "wolof"])
